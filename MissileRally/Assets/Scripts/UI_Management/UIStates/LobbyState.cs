...
public class LobbyState : AUIState
{
    ...
    TextMeshProUGUI playersReadyText;   //Referencia al texto de la interfaz que indica el número de jugadores listos del lobby 
    ...
    public override void Enter()
    {
        ...
        if (GameManager.Instance.mapSelectedId == 0) //Si el host de la partida na ha seleccionado un mapa todavía, el texto de la interfaz de todos los jugadores cambia
        {
